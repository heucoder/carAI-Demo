...
class car:
    ...
    def get_onepos(self, x1, x2, y1 , y2, r):
        if r >= 0 and r < math.pi / 2:
            if x1 < x2 or x2 == -1:
                return (x1,y1)
            else:
    ...
    def get_dis_to_wall(self, p1, radius1, p0, radius0):
        ...
        r1 = self.r%(2*math.pi)
        self.dis_pos = self.get_onepos(x1,x2,y1,y2,r1)
        ...
        self.ldis_pos = self.get_onepos(x1,x2,y1,y2,r2)
        ...
        self.lldis_pos = self.get_onepos(x1,x2,y1,y2,r3)
        ...
        self.rdis_pos = self.get_onepos(x1,x2,y1,y2,r4)
        ...
        self.rrdis_pos = self.get_onepos(x1,x2,y1,y2,r5)
